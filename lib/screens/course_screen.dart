              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Material(
                        // if isVideosSection condition is true then that color will be on button and if condition is false then  that color will be shown on button but with some opacity to
                ...
                // Other Video Section and description
                SizedBox(height: 10),
                // id isVideosSection condition is true then VideoSection will be shown anf if condition is false it means DescriptionSection will be shown
